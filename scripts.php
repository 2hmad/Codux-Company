...
<script>
    ...
    e.src="https://widget.customerly.io/widget/12836816";
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-144638050-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-144638050-1');
</script>
...
<script>
var typed3 = new Typed('.typejs1', {
  strings: ['<strong>Businesses</strong>', '<strong>Individuals</strong>'],
  typeSpeed: 50,
  backSpeed: 50,
  smartBackspace: true,
  loop: true
